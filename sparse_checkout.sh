...
git_folder_location='/c/Users/Tarun Malik/Downloads/mlopsv2-root/mlops-v2/mlops-v2'   #replace with the local root folder location where you want to create the project folder
project_name=ml2ops-project   #replace with your project name
github_org_name=tarunmlops   #replace with your github org name
project_template_github_url=https://github.com/azure/mlops-project-templates   #replace with the url for the project template for your organization created in step 2.2, or leave for demo purposes
